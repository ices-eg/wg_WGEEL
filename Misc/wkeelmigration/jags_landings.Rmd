...
ggplot(cou) +
  ...
  ylab("") +
  facet_wrap(~period)
ggsave("glasseel_landings.png", height=12/2.54, width = 16/2.54, dpi = 300)
```
...
ggplot(cou) +
  ...
  ylab("") +
  facet_wrap(~period)
ggsave("silver_landings_marine_coastal_transitional.png", height=12/2.54, width = 16/2.54, dpi = 300)
```
...
ggplot(cou) +
  ...
  ylab("") +
  facet_wrap(~period)
ggsave("silver_landings_freshwater.png", height=12/2.54, width = 16/2.54, dpi = 300)
```
