...
pattern_GE_landings=do.call("rbind.data.frame",lapply(seq_len(length(levels(groups))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
  ...
  hty_code="T"
  lfs_code="G"
  esp <- tmp[,grep(paste("alpha_group\\[",g,",",sep=""),name_col)]
...
pattern_Ycoast_landings=do.call("rbind.data.frame",lapply(seq_len(length(levels(groups))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
  emu_nameshort=substr(name,start=1,stop=ncar-2)
  period=substr(name,start=ncar,stop=ncar)
...
pattern_Ytrans_landings=do.call("rbind.data.frame",lapply(seq_len(length(levels(groups))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
  emu_nameshort=substr(name,start=1,stop=ncar-2)
  period=substr(name,start=ncar,stop=ncar)
...
pattern_Yfresh_landings=do.call("rbind.data.frame",lapply(seq_len(length(levels(groups))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
  emu_nameshort=substr(name,start=1,stop=ncar-2)
  period=substr(name,start=ncar,stop=ncar)
...
pattern_Smar_coast_trans_landings=do.call("rbind.data.frame",lapply(seq_len(length(levels(groups))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
...
pattern_Sfresh_landings=do.call("rbind.data.frame",lapply(seq_len(length(levels(groups))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
  emu_nameshort=substr(name,start=1,stop=ncar-4)
  period=substr(name,start=ncar,stop=ncar)
...
pattern_YS_landings=do.call("rbind.data.frame",lapply(seq_len(length(unique(group))),function(g) {
  name <- group_name[g]
  ncar=nchar(name)
  emu_nameshort=substr(name,start=1,stop=ncar-4)
  period=substr(name,start=ncar,stop=ncar)
