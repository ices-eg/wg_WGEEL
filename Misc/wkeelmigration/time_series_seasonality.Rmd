...
if(sys.user()=="hdrouineau"){
  source("../../R/utilities/load_library.R")
source("functions.R")
  source("../../R/shiny_data_integration/shiny_di/loading_functions.R")
  source("../../R/shiny_data_integration/shiny_di/database_reference.R") # extract_ref
  load(file="../../R/shiny_data_integration/shiny_di/common/data/init_data.Rdata")  
  datawd <- "../../../../wkeelmigration/source/"
  imgwd <- "../../../../wkeelmigration/image/"
  datawd1 <- "../../../../wkeelmigration/Treated commercial/"
  }
...
dsn <-  paste0("PG:dbname='",cred$dbname,"' host='",
cred$host,"' port ='", cred$port,"'  user='", cred$user,
...
load( paste0(datawd,"saved_data.Rdata"))
