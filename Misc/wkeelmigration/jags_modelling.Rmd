...
It leads to a dataset with `r nrow(silvereel_wide)` rows. Since seasons are not comparable among years, months correspond to original months (eg: 12 for decembre, not month in season), while rows indeed correspond to seasons.
...
Best solutions arise with 3 clusters (as for other stages).
