...
ggplot(get_pattern_month(myfit_yellow),aes(x=month,y=proportion))+
  ...
  theme_bw()
```
Cluster 5 corresponds to a migration 5 concentrated in june and july. Cluster 2 is a bit similar, but more widespread from may august. Cluster 1 is very flat display a flat wave, from may to november. Clusters 3 and 4 are quite similar with widepread waves centered around summer and eraly autumn, with cluster 3 more widepread than cluster 4.
