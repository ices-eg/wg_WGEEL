...
![The hierachical levels for WGEEL in the Habitat database for diadromous fishes.](images/clipboard-1857698266.png){#fig-hierarchical}

The hierarchical structure of the habitat ranges from stock level to river section level (Figure XX) . This hierarchical level allows to aggregate data from the lower level to the upper level. E.g data collected for one river or one lagoon can be aggregated as a regional (Figure @fig-regional) level or sub-Component (Substock) level.
