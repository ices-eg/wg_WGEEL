...
The first phase will begin next year, for example, with the entry of data from scientific surveys into the ICES Scientific Surveys Database. All the changes planned for 2027 are summarized in the below (see @par-planned_change).


 
## For next year{#par-planned_change}
...
::: {custom-style="Annex heading" #sec-annex_61}
Annex The table of EDMO codes
:::

::: {custom-style="Annex heading" #sec-annex_62}
Annex Commercial series in Annex 9
:::

```{r}
#| label: tbl-annex9
#| tbl-cap: "Series identified in annex 9 which correspond to commercial fisheries. These should not be submitted to the Diadromous database. Instead they should be submitted to the RDBES or RDBFIS in 2028."
...
::: {custom-style="Annex heading" #sec-annex_63}
Annex Commercial series in annex 2 and 3
:::

```{r}
#| label: tbl-annex2and3
#| tbl-cap: "Series identified in annex 2 and 3 which correspond to commercial fisheries. These should not be submitted to the Diadromous database. They should be submitted instead to RDBES or RDBFIS in 2028."
...
::: {custom-style="Annex heading" #sec-annex64}
Annex : Scientific series for Yellow and Silver eels.
```{r}
#| label: tbl-annex23sc
#| tbl-cap: "Series identified in annex 2 and 3 which correspond to scientific sampling and should be submitted to the Diadromous database."
...
GEEL notes that the availability, quality and consistency of recreational fisheries data for European eel remain limited and that improvements to the data basis would support future stock assessments.
WGEEL therefore recommends strengthening collaboration between eel stock assessment experts and the relevant expert groups dealing with recreational fisheries data, in particular ICES WGRFS and the DCF RCG ISSG Recreational Fisheries. This collaboration can improve communication of the specific data needs for eel stock assessment, ensuring that these end-user requirements are adequately reflected in the development and refinement of DCF recreational fisheries data collection methodologies. In the longer term, closer alignment between assessment needs and data collection methodologies can then contribute to improved availability, quality and consistency of recreational fisheries data for European eel and thereby strengthen the data basis for stock assessment.
