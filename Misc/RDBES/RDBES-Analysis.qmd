...
The diadromous DB is currently being developped in ICES. A first version of the database and API is planned for next year. The feedback on issues on the format is here : ices-tools-dev/DiadromousData: Development of the eel database and format

The current data for series and metrics (annex 1 to 3 and 9) will be imported (bulk import) during the next year. Series indentified as commercial sampling
