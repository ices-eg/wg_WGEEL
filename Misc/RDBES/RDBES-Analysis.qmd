...
The first phase will begin next year, for example, with the entry of data from scientific surveys into the diadromous Database. All of the changes planned for 2027 are summarized in the callout box below.
