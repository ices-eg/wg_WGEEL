...
(Add CL coastal lagoon)
use (MO MC FW CL T)

Add life stage (See Vocab Stage)
Check if we can make it conditional mandatory Landing location (Should be conditional mandatory on Freshwater - most freshwater will not have harbour)
