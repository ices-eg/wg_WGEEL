...
In order to adhere to the FAIR principles, for an efficient and complete data collection and distribution, work has been done to harmonize the data annually requested by WGEEL to the RDBES/RDFIS and the developing Diadromous database which will host data from scientific sampling of diadromous species. To fully transition, from the WGEEL database to the ICES and GFCM databases, several changes to the usual data call process are being proposed for 2027. The details of the new process to be followed in 2027 will be provided in the next paragraphs of this chapter
...
#| tbl-cap: "Fishery-dependent series identified in annexes 2, 3 and 9 which should be submitted to the Diadromous database through RDBES in 2028."
