...
```
```{r plotb0alternative}
ggplot(indicator_sub,aes(x=b0,y=b0_estimated))+geom_point(aes(col=eel_cou_code))+xlab(expression("reported B"[0]))+ ylab(expression("estimated B"[0])) + geom_abline(intercept=0, slope= 1, lty=2) + scale_color_discrete("country code")
