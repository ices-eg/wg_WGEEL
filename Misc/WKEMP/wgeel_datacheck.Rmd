...
values of landings, average over 5 last years
```{r fisheries}
...
ggplot(landings,aes(x=eel_year,y=eel_value/1e3))+geom_line(aes(col=eel_emu_nameshort))+
  scale_y_log10()+
...
Landings are not decreasing, this suggests that situation has likely not improved in these countries.
