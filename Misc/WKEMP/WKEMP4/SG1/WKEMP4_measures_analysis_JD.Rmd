...
measures_target_table <- measures_target %>% 
  ...
  select(emu_name_short, measure_type, measure_description, target_value, target_unit, target_value_achieved) %>%
  mutate(target_value = (paste(target_value, target_unit, sep = " ")),
         target_value_achieved = (paste(target_value_achieved, target_unit, sep = " "))) %>% 
  select(-target_unit) %>% 
