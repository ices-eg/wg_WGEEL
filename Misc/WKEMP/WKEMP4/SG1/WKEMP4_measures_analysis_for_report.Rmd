...
ggsave("facet_plot.jpg", plot = plot3, height = 7, width = 5)  # Adjust the height and width as needed
...
# Save the plot with a specified height
ggsave("facet_progress.jpg", plot = plot3_progress, height = 7, width = 5)  # Adjust the height and width as needed

# Include the saved plot in the RMarkdown document
knitr::include_graphics("facet_progress.jpg")

```
```{r ImplementationPercentage_byCountry_OLD, include=FALSE}
# Function to replace underscores with spaces and capitalize the first letter of each word
clean_names <- function(name) {
  if (!is.na(name)) {
    name <- gsub("_", " ", name)
...
# Save the plot with a specified height
ggsave("facet_effectiveness.jpg", plot = plot3_effectiveness, height = 7, width = 5)  # Adjust the height and width as needed
