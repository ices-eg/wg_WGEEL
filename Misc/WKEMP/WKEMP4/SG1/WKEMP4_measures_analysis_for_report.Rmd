...
measures_all$measure_type <- gsub("Other", "Uncategorized", measures_all$measure_type)
...
# Ensure the progress column is a factor with the correct levels
ProgressCountTable_long$progress <- factor(ProgressCountTable_long$progress, levels = unique(measures_all$progress))
...
# Create the stacked bar chart with rotated x-axis labels and viridis color palette
