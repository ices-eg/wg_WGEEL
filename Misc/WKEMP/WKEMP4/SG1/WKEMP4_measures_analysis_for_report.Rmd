...
author: "THIS IS OLD VERSION. Use WKEMP4_measures_analysis_JH INSTEAD. AND _JD for extra tables."
date: "`r Sys.Date()`"
...
```{r NoOfMeasuresPerCountryA, echo=FALSE}
...
```{r NoOfMeasuresPerCountryB, echo=FALSE}
