...
load(file = file.path("data_dependencies", "annex16.RData"))
...
::: {custom-style="Image Caption"}
Figure: `r run_bookmark("fig-check_proportion", runs_figure)`: Proportion of glass eel marked as restocking material reported by France, `trade only` identifies the proportion of glass eel that was used in trade, `including France restocking` incudes the amount of glass eel released in France as part of the restocking program.
:::
