...
knitr::opts_chunk$set(echo = FALSE, warning=FALSE,message=FALSE, error=FALSE, fig.height=16/2.54,fig.width=16/2.54)
```
...
```{r function_precodiag, message=FALSE, warning=FALSE}
...
## Precautionary diagrams for countries in 2023.

```{r message=FALSE, warning=FALSE, fig.width=25/2.54}

trace_precodiag3(precodata_all, "country", last_year=2023, years = 2023)

```


## Precautionary diagrams for countries in 2022

```{r message=TRUE, warning=TRUE, fig.width=25/2.54}

trace_precodiag3(precodata_all,"country",last_year=FALSE,years=2022)

```


## Precautionary diagrams for countries in 2021

```{r message=TRUE, warning=TRUE, fig.width=25/2.54}

trace_precodiag3(precodata_all, "country", last_year = FALSE, years = 2021)
...
trace_precodiag3(precodata_all,"emu",last_year=2023,years=2023)
...
trace_precodiag3(precodata_all,"emu",last_year=FALSE,years=2022)
...
trace_precodiag3(precodata_all, "emu", last_year = FALSE, years = 2021)

```

# EMU Bcurr_without_stocking/B0

## 2023

```{r message=FALSE, warning=FALSE, fig.width=25/2.54}

trace_precodiag3(precodata_all,"emu",last_year=2023,years=2023, stocking = FALSE)
...
trace_precodiag3(precodata_all,"emu",last_year=FALSE,years=2022, stocking = FALSE)
...
trace_precodiag3(precodata_all, "emu", last_year = FALSE, years = 2021, stocking = FALSE)
...
trace_precodiag3(precodata_all %>% filter(eel_emu_nameshort %in% mor_wise$emu_nameshort),"emu",last_year=FALSE,years=2023)
ggsave("2024/image//2023.png",width=30/2.54,height=18/2.54 )
...
trace_precodiag3(precodata_all %>% filter(eel_emu_nameshort %in% mor_wise$emu_nameshort),"emu",last_year=FALSE,years=2022)
ggsave("2024/image//2022.png",width=30/2.54,height=18/2.54 )
...
trace_precodiag3(precodata_all %>% filter(eel_emu_nameshort %in% mor_wise$emu_nameshort),"emu",last_year=FALSE,years=2021)
ggsave("2024/image//2021.png",width=30/2.54,height=18/2.54 )
