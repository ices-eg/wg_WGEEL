...
flextable(Kendall_table %>%
  ...
  set_header_labels(Period_b0 = "Period",
                    n_b0 = "n",
                    Esc_perc_b0_initial = "Bcurrent/B0",
                    Esc_perc_b0_current = "Bcurrent/B0",
...
flextable(fisher_sumA) %>% autofit() %>% set_caption(caption = "\u03A3A") %>%
...
flextable(fisher_sumF) %>% autofit() %>% set_caption(caption = "\u03A3F") %>%
  set_header_labels(implemented_0 = "implemented/no effect",
                    implemented_1 = "implemented/effect",
                    not_implemented_0 = "not implemented/no effect",
                    not_implemented_1 = "not implemented/effect")

flextable(fisher_sumH) %>% autofit() %>% set_caption(caption = "\u03A3H") %>%
  set_header_labels(implemented_0 = "implemented/no effect",
                    implemented_1 = "implemented/effect",
                    not_implemented_0 = "not implemented/no effect",
                    not_implemented_1 = "not implemented/effect")
...
>>>>>>> 9a678a502a25a946cec8b2c06e9f74113514182e
...
*Fig* Logistic regression of change in Bcurren/B0_adjusted over Delta sumA

*Tab* Model statistics for Logistic regression of change in Bcurrent/B0_adjusted over Delta sumA. (For the time period see Kendall table)

```{r delta_Bcurr_vs_sigA_table}
logit_delta_table <- as.data.frame(summary(logit_delta)$coefficients) %>%
...
ggplot(meas_mort, aes(x=suma_initial, y=delta_suma)) +
  geom_point(size = 1) + 
   geom_text_repel(aes(label = eel_emu_nameshort, col = start_year), size = 3.2)+ 
  theme_bw()+
