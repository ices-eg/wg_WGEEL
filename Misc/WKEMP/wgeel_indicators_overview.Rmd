...
ggsave(b0trend, "b0_trend.png",height=16/2.54,width=16/2.54)
...
ggsave(b0ratio, "b0_ratio.png",height=16/2.54,width=16/2.54)
...
Kendall_b0_tab <-  indicator %>%
                    ...
                    mutate(ratio_b0 = bcurrent/b0,
                           ratio_b0_without_stocking = bcurrent_without_stocking/b0) %>%
                    ...
                    select(eel_emu_nameshort, Period_b0, n_b0,n_b0_without_stocking, Esc_perc_b0_initial, Esc_perc_b0_initial_without_stocking, Esc_perc_b0_current,Esc_perc_b0_current_without_stocking, Delta_b0, Delta_b0_without_stocking) %>%
                    unique() %>%
                    ungroup() %>%
                    arrange(eel_emu_nameshort) %>%
  ...
  left_join(Kendall_bio_b0_without_stocking, by = "eel_emu_nameshort") %>%
                    rename(p_b0 = sl,
                      ...
                      Tau_b0_without_stocking = tau_without_stocking,
