...
Kendall_b0_adj_tab <-  indicator %>%
                    group_by(eel_emu_nameshort) %>%
                    filter(eel_year >= 2007 & !is.na(b0_adj) & !is.na(bcurrent)) %>% 
...
flextable(Kendall_table %>%
            ...
            select(EMU, Period_b0, Period_b0_adj, n_b0, n_b0_adj, Esc_perc_b0_initial, Esc_perc_b0_current, Esc_perc_b0_adj_initial, Esc_perc_b0_adj_current, Delta_b0, Delta_b0_adj, Tau_b0, Tau_b0_adj) %>%
            mutate_all(~ifelse(is.nan(.), NA, .)) %>%
            filter_at(vars(n_b0, n_b0_adj, Esc_perc_b0_initial, Esc_perc_b0_current, Esc_perc_b0_adj_initial, Esc_perc_b0_adj_current, Delta_b0, Delta_b0_adj, Tau_b0, Tau_b0_adj), any_vars(!is.na(.)))) %>%
            autofit()
```
