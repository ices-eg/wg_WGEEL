...
Progress_visualisation <- Kendall_table %>%
  select(eel_emu_nameshort, Esc_perc_b0_current, Delta_b0, suma_current, Delta_suma, Esc_perc_b0_initial, suma_initial) %>% 
...
columns <- c("Esc_perc_b0_current", "Delta_b0", "suma_current", "Delta_suma", "Esc_perc_b0_initial", "suma_initial")
...
flextable(Progress_visualisation) %>% set_header_labels(eel_emu_nameshort = "EMU",
                    Esc_perc_b0_current = "Current escapement (in % pristine)",
                    Esc_perc_b0_initial = "Escapement > 40% pristine (initial)",
                    suma_current = "\u03A3A",
                    suma_initial = "\u03A3A (initial)",
                    Delta_suma = "Change in \u03A3A since implementation",
                    Delta_b0 = "Change in escapement since implementation (in % pristine)") %>% 
