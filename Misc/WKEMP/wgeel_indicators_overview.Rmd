...
fisher_sumA$p_value <- apply(fisher_sumA %>% select(-implemented_NA, - not_implemented_NA), 1 ,function(x) {
...
fisher_sumF$p_value <- apply(fisher_sumF %>% select(-implemented_NA, - not_implemented_NA), 1 ,function(x) {
                                        tbl <- matrix(as.numeric(x[2:5]), ncol=2, byrow=T)
                                        fisher.test(tbl)$p.value
                                        })
...
fisher_sumH$p_value <- apply(fisher_sumH %>% select(-implemented_NA, - not_implemented_NA), 1 ,function(x) {
                                        tbl <- matrix(as.numeric(x[2:5]), ncol=2, byrow=T)
                                        fisher.test(tbl)$p.value
                                        })
...
fisher_b0_adj$p_value <- apply(fisher_b0_adj %>% select(-implemented_NA, - not_implemented_NA), 1 ,function(x) {
                                        tbl <- matrix(as.numeric(x[2:5]), ncol=2, byrow=T)
                                        fisher.test(tbl)$p.value
                                        })
...
flextable(fisher_sumA) %>% set_caption(caption = "\u03A3A") %>%
  set_header_labels(implemented_0 = "implemented/no effect",
                    ...
                    implemented_NA = "implemented/not tested",
                    not_implemented_NA = "not implemented/not tested",
...
flextable(fisher_b0_adj) %>% set_caption(caption = "b0 adj") %>%
  set_header_labels(implemented_0 = "implemented/no effect",
                    implemented_1 = "implemented/effect",
                    not_implemented_0 = "not implemented/no effect",
                    not_implemented_1 = "not implemented/effect",
