...
read_annex13 <- function(filename){
	...
	do.call(rbind.data.frame,lapply(sheet,function(s){
						...
						indirect_assessment_B0 <- readWorksheetWithNull(wb, s, startRow=55, startCol=2, endRow=55, endCol=2,header=FALSE) 
						indirect_assessment_bbest_bcurrent <- readWorksheetWithNull(wb, s, startRow=55, startCol=3, endRow=55, endCol=3,header=FALSE) 
						...
						# method mortality
						impact_fishery <- readWorksheetWithNull(wb, s, startRow=62, startCol=2, endRow=62, endCol=2, header=FALSE)
						impact_fishery_description <- readWorksheetWithNull(wb, s, startRow=62, startCol=3, endRow=62, endCol=3, header=FALSE)
						impact_hp <- readWorksheetWithNull(wb, s, startRow=63, startCol=2, endRow=63, endCol=2, header=FALSE)
						impact_hp_description <- readWorksheetWithNull(wb, s, startRow=63, startCol=3, endRow=63, endCol=3, header=FALSE)
						impact_habitat <- readWorksheetWithNull(wb, s, startRow=64, startCol=2, endRow=64, endCol=2, header=FALSE)
						impact_habitat_description <- readWorksheetWithNull(wb, s, startRow=64, startCol=3, endRow=64, endCol=3, header=FALSE)
						impact_restocking <- readWorksheetWithNull(wb, s, startRow=65, startCol=2, endRow=65, endCol=2, header=FALSE)
						impact_restocking_description <- readWorksheetWithNull(wb, s, startRow=65, startCol=3, endRow=65, endCol=3, header=FALSE)
						impact_other <- readWorksheetWithNull(wb, s, startRow=66, startCol=2, endRow=66, endCol=2, header=FALSE)
						impact_other_description <- readWorksheetWithNull(wb, s, startRow=66, startCol=3, endRow=66, endCol=3, header=FALSE)
						biomass_method_ref <- readWorksheetWithNull(wb, s, startRow=69, startCol=2, endRow=69, endCol=2, header=FALSE)
						mortality_method_ref <- readWorksheetWithNull(wb, s, startRow=70, startCol=2, endRow=70, endCol=2, header=FALSE)
						biomass_method_ground_truth <- readWorksheetWithNull(wb, s, startRow=72, startCol=2, endRow=72, endCol=2, header=FALSE)
						mortality_ground_truth <- readWorksheetWithNull(wb, s, startRow=73, startCol=2, endRow=73, endCol=2, header=FALSE)
						
						# traceability
						traceability_scheme_EMU <- readWorksheetWithNull(wb, s, startRow=76, startCol=2, endRow=76, endCol=2, header=FALSE)
						traceability_scheme_EMU_description <- readWorksheetWithNull(wb, s, startRow=76, startCol=3, endRow=76, endCol=3, header=FALSE)
						traceability_scheme_country <- readWorksheetWithNull(wb, s, startRow=77, startCol=2, endRow=77, endCol=2, header=FALSE)
						traceability_scheme_country_description <- readWorksheetWithNull(wb, s, startRow=77, startCol=3, endRow=77, endCol=3, header=FALSE)
						traceability_changed <- readWorksheetWithNull(wb, s, startRow=79, startCol=2, endRow=79, endCol=2, header=FALSE)
						traceability_difficulties <- readWorksheetWithNull(wb, s, startRow=80, startCol=2, endRow=80, endCol=2, header=FALSE)
						
						# reserving60%
						
						reserving_60_monitoring  <- readWorksheetWithNull(wb, s, startRow=83, startCol=2, endRow=83, endCol=2, header=FALSE) 
						reserving_60_monitoring_description <- readWorksheetWithNull(wb, s, startRow=83, startCol=83, endRow=83, endCol=3, header=FALSE)
						reserving_60_changed <- readWorksheetWithNull(wb, s, startRow=84, startCol=2, endRow=84, endCol=2, header=FALSE) 
						reserving_60_changed_description <- readWorksheetWithNull(wb, s, startRow=84, startCol=3, endRow=84, endCol=3, header=FALSE)
						reserving_60_difficulties <- readWorksheetWithNull(wb, s, startRow=85, startCol=2, endRow=85, endCol=2, header=FALSE) 
						reserving_60_difficulties_description <- readWorksheetWithNull(wb, s, startRow=85, startCol=3, endRow=85, endCol=3, header=FALSE)
						
						# control
						catch_monitoring_exists_control <- readWorksheetWithNull(wb, s, startRow=88, startCol=2, endRow=88, endCol=2, header=FALSE) 
						catch_monitoring_adapted_inland <- readWorksheetWithNull(wb, s, startRow=89, startCol=2, endRow=89, endCol=2, header=FALSE) 
						catch_monitoring_changed <- readWorksheetWithNull(wb, s, startRow=90, startCol=2, endRow=90, endCol=2, header=FALSE) 
						
						# Difficulties
						
						difficulties_1 <- readWorksheetWithNull(wb, s, startRow=94, startCol=2, endRow=94, endCol=2, header=FALSE) 
						difficulties_2 <- readWorksheetWithNull(wb, s, startRow=95, startCol=2, endRow=95, endCol=2, header=FALSE) 
						difficulties_3 <- readWorksheetWithNull(wb, s, startRow=96, startCol=2, endRow=96, endCol=2, header=FALSE) 
						difficulties_4 <- readWorksheetWithNull(wb, s, startRow=97, startCol=2, endRow=97, endCol=2, header=FALSE) 
						difficulties_5 <- readWorksheetWithNull(wb, s, startRow=98, startCol=2, endRow=98, endCol=2, header=FALSE) 
						difficulties_6 <- readWorksheetWithNull(wb, s, startRow=99, startCol=2, endRow=99, endCol=2, header=FALSE) 
						
						# Good practises
						
						good_practises_1 <- readWorksheetWithNull(wb, s, startRow=102, startCol=2, endRow=102, endCol=2, header=FALSE) 
						good_practises_2 <- readWorksheetWithNull(wb, s, startRow=103, startCol=2, endRow=103, endCol=2, header=FALSE) 
						good_practises_3 <- readWorksheetWithNull(wb, s, startRow=104, startCol=2, endRow=104, endCol=2, header=FALSE) 
						good_practises_4 <- readWorksheetWithNull(wb, s, startRow=105, startCol=2, endRow=105, endCol=2, header=FALSE) 
						good_practises_5 <- readWorksheetWithNull(wb, s, startRow=106, startCol=2, endRow=106, endCol=2, header=FALSE) 
						good_practises_6 <- readWorksheetWithNull(wb, s, startRow=107, startCol=2, endRow=107, endCol=2, header=FALSE) 
						...
						data.frame(cou_code=cou_code,
								...
								indirect_assessment_B0=indirect_assessment_B0,
								indirect_assessment_bbest_bcurrent=indirect_assessment_bbest_bcurrent,								
								...
								reserving_60_monitoring_description =reserving_60_monitoring_description,
								reserving_60_changed =reserving_60_changed,
								reserving_60_changed_description =reserving_60_changed_description,
								reserving_60_difficulties =reserving_60_difficulties,
								...
								good_practises_6 = good_practises_6
...
annexes13_management <- annexes13_table[,c(1,2,108:122)]
save(annexes13_method,annexes13_traceability,annexes13_management, file=str_c(datawd,"res/annex13.Rdata"))
wb = loadWorkbook(str_c(datawd,"res/annex13.xlsx"),create=FALSE)
