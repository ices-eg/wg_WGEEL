...
The following table (Table @tbl-lastreport) provide checks for the latest reported value per EMU, values in grey in column country and emu indicate that probably values where not reported for that EMU. Not that reporting ND
