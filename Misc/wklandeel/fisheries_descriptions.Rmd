...
```
\
Fig 4: Known minimum uncertinty by lifestage; represented as the sum of differences between upper and lower boundary from all gear types and EMUs where respective data was reported.
