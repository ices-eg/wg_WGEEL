...
yellow eel dominated by recruits from the year (GY) and young yellow eel (Y)
recruiting to continental habitats (Dekker, 2002). 
\item Yellow eel (Y) which might consist of yellow eel of several ages. 
This is certainly the case for all series from the Baltic, and other sites. 
\end{itemize}
...
%************************************************************************************
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<< model_for_glass_eel_and_yellow_eel_and_datasets, echo=FALSE, eval=TRUE, results=hide >>=
