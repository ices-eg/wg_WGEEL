...
printstatseries<-printstatseries[order(printstatseries$order),c(1,11,2:9,12)]
...
xstatseries <- xtable(x = printstatseries[1:20,], 
		...
		align=c("p{0cm}","p{1cm}","p{1cm}","p{1cm}","p{1cm}","p{0.8cm}","p{0.8cm}","p{1.5cm}","p{2.5cm}","p{2cm}","p{2cm}","p{1.5cm}"),
		digits=0)
print(xstatseries , 
