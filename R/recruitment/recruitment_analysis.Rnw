...
\graphicspath{{F:/workspace/wgeeldata/recruitment/2016/image/}} 
...
opt_std="1979-1994" #"1979-1994" or "all"
...
wger[wger$area%in%c("Atlantic","Baltic","Mediterranean Sea"),"area"]<-"Elsewhere Europe"
...
series_CY<-R_stations[R_stations$ser_nameshort%in%names(last_year[last_year==CY]),c("ser_nameshort","ser_namelong","cou_code","ser_lfs_code","areashort","ser_area_division")]
...
series_CYm1<-R_stations[R_stations$ser_nameshort%in%names(last_year[last_year==CY-1]),c("ser_nameshort","ser_namelong","cou_code","ser_lfs_code","areashort","ser_area_division")]
...
if (opt_std=="all") {
	# do nothing
} else if (opt_std=="1979-1994"){
	glass_eel_yoy$value_std<-glass_eel_yoy$value_std_1979_1994
} else stop ("opt_std should be all or 1979-1994")
model_ge_area=glm(value_std~year_f:area+site,data=glass_eel_yoy[glass_eel_yoy$value>0 & glass_eel_yoy$year>1959,],
...
vv$modelge$excludedsite<-unique(glass_eel_yoy[glass_eel_yoy$site%in%vv$modelge$excluded,"site"])
vv$modelge$excludedsite<-unique(glass_eel_yoy[glass_eel_yoy$site%in%vv$modelge$excluded,"site"])
vv$modelge$value_excluded_zero<-glass_eel_yoy[glass_eel_yoy$value==0&!is.na(glass_eel_yoy$value),c("value_std","site","year","lifestage","das_comment","area")]

model_older=glm(value_std~year_f+as.factor(site),data=older,family=Gamma(link=log),subset=older$value>0 & older$year>1949  ,maxit=300)
vv$modelolder<-list()
...
vv$modelolder$excludedsite<-unique(older[older$site%in%vv$modelolder$excluded,"site"])
vv$modelolder$value_excluded_zero<-older[older$value==0,c("value_std","site","year","lifestage","das_comment","area")]
...
unique(older$site)
model_older=glm(value_std~year_f+as.factor(site),data=older,family=Gamma(link=log),subset=older$value>0 &
...
data_bis=expand.grid(year_f=unique(model_older$xlevels$year_f),site=model_older$xlevels$`as.factor(site`)
...
\tiny
\input{F:/workspace/wgeeldata/recruitment/2016/table/table_glm_glass_eel.tex}
\input{F:/workspace/wgeeldata/recruitment/2016/table/table_glm_yellow.tex}
\normalsize
...
%==========================================
 ...
 %====================================
	\input{F:/workspace/wgeeldata/recruitment/2016/table/table_seriesCY.tex}
 %====================================

 %====================================
	\input{F:/workspace/wgeeldata/recruitment/2016/table/table_seriesCYm1.tex}
 %====================================

 %====================================
	\input{F:/workspace/wgeeldata/recruitment/2016/table/table_serieslost.tex}
 %====================================
\normalsize

\small
 %====================================
	\input{F:/workspace/wgeeldata/recruitment/2016/table/table_statseries.tex}
 %====================================
\normalsize
\small
 %====================================
	\input{F:/workspace/wgeeldata/recruitment/2016/table/table_statseries1.tex}
 %====================================F
\normalsize
\small
 %====================================
	\input{F:/workspace/wgeeldata/recruitment/2016/table/table_statseries2.tex}
 %====================================
\normalsize
%\newpage
%\small
% %====================================
%\input{F:/workspace/wgeeldata/sweave/2016/table/table_n_y_area.tex}
% %====================================
%\normalsize
%\small
% %====================================
%\input{F:/workspace/wgeeldata/sweave/2015/table/table_n_y_lfs.tex}
% %====================================
%\normalsize
\end{document}
sdfsdf
