...
if(getUsername() == 'cedric.briand')
{
  ...
  shinywd <- "C:/Users/cedric.briand/Documents/GitHub/WGEEL/data/"
}
...
# these data will 
save(wger_init,R_stations,file=str_c(datawd,"wger_init.Rdata"))
save(statseries,file=str_c(datawd,"statseries.Rdata"))
save(R_stations,file=str_c(datawd,"R_stations.Rdata"))

save(wger_init,R_stations,file=str_c(shinywd,"wger_init.Rdata"))
