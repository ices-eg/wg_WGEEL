...
wger$area[wger$site=="Yser"]<-"Elsewhere Europe"
#########################################################################
...
} else if (opt_std=="2000-2009"){
	glass_eel_yoy$value_std<-glass_eel_yoy$value_std_2000_2009
} else stop ("opt_std should be all or 1979-1994 or 2000-2009")
glass_eel_yoy<-glass_eel_yoy[!is.na(glass_eel_yoy$value_std),]
