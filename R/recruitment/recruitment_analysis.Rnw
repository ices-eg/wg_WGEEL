...
recruitment has stopped to decrease, and is now increasing with a rate
significantly different from zero. However, first, not all series have been
reported for 2019 and the results might change when those are reported.
