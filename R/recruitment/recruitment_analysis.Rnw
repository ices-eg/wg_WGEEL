...
%************************************************************************************
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<< test_period, echo=FALSE, eval=TRUE, results=hide >>=
...
run_exclude_before <- function(the_year, dat_ge_reference=dat_ge){
...
res <- mapply(run_exclude_before, the_year=c(2010:2021))
@
