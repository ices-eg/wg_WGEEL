...
xseries_CYm1 <- xtable(x = series_CYm1,
	...
	caption = str_c("Series updated to ",CY-1, " see table \\ref{table_seriesCY)} for codes. Series ordered by last year"),
	align=c("p{0cm}","p{1.3cm}","p{6.5cm}","p{1cm}","p{1cm}","p{1cm}","p{1.4cm}"))
...
#1960-1980 
data_bis$mean=mean(data_bis[data_bis$year<1980,"p"])
data_bis$yellow_eel=exp(data_bis$p-data_bis$mean)
