...
series_CY<-series_CY[order(series_CY$ser_lfs_code,series_CY$ser_order),-ncol(series_CY)]
...
series_CYm1<-R_stations[R_stations$ser_nameshort%in%names(last_year[last_year==CY-1]),
		c("ser_nameshort","ser_namelong","cou_code","ser_lfs_code","areashort","ser_area_division","ser_order")]
series_CYm1<-series_CYm1[order(series_CYm1$ser_lfs_code,series_CYm1$ser_order),-ncol(series_CYm1)]
