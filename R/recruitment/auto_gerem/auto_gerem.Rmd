...
updatedData = FALSE
if ((!file.exists(paste("datagerem",CY,".rdata",sep="")))){
  if (username=="hilaire.drouineau"){
  ...
  con_wgeel=dbConnect(Postgres(),
                      ...
                      port=cred$port,
  	                  user= cred$user,
  	                  password= getPass("wgeel db password"))
  updatedData = TRUE
...
if  ((!file.exists(paste("gerem",CY,".rdata",sep=""))) ){
...
In 2022, the recruitment seems to have increased mostly in the Mediterranean and in the INWGB regions. Since these two zones do not represent the largest part of the recruitment, those increase did not have a major effet on the overall effect. On the other hand, since time series from INWGB are overrepresented, it has had a huge effect on the GLM analysis.
