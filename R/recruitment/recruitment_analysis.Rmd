...
In Elsewhere Europe, the mean value in 2026 is higher than the mean value
in 2025, and as last year, the maps of residuals still suggest a potential 
spatial pattern with some higher positive residuals in northern latitudes 
(Figure \@ref(fig:figuremapresidyoy)). The mean value in 2026 in North Sea
is almost similar as last year. It should be reminded that those 2026 results
...
of the last values of indices compared to the overall trend. To do so, we used the 
model adapted and used the model of Bénézech et al. (2024).
...
Figure \@ref(fig:retrospective) shows that the variations of the GLM have 
varied through 
...
Despite this relatevely high Mohn’s rho index, the retrospective diagrams do not display specific 
