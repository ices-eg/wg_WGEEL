...
```{r load_database, echo=FALSE, fig=FALSE, eval=FALSE, results="hide"}
...
```{r load_rdata, echo=FALSE, fig=FALSE, eval=TRUE, results="hide"}
...
```{r select_series, echo=FALSE, fig=FALSE, eval=TRUE, results="hide", warning = FALSE, error = FALSE}
...
```{r table_series,echo=FALSE, eval=TRUE,fig=FALSE, results="hide"}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r figure_series, echo=FALSE,  eval=TRUE, results="hide" }
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%************************************************************************************
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r mapseries,echo=FALSE, eval=TRUE,results="hide"}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%************************************************************************************
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r tableswgeel,echo=FALSE, eval=FALSE,results="hide"}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%************************************************************************************
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r figure1, fig.cap="Zone definition and available data", fig.width=16/2.54}
...
```{r xstatseriesGEE, echo=FALSE}
 xstatseriesGEE
```


```{r xstatseriesGNS, echo=FALSE}
	xstatseriesGNS
```

```{r xstatseriesGY, echo=FALSE}
xstatseriesGY
```


```{r xstatseriesY, echo=FALSE}
xstatseriesY
```


```{r xseries_prob, echo=FALSE}
xseries_prob
```


```{r xseries_prob1, echo=FALSE}
xseries_prob1
```


```{r xseries_prob2, echo=FALSE}
xseries_prob2
```
...
```{r figure2, fig.cap="Trends in number of glass eel (black circle), glass+young yellow eel (grey triangle) and older yellow eel (black triangle) time-series giving a report in  any specific year.", fig.width=16/2.54}
knitr::include_graphics(paste0(imgwd,"figure2.png"))
```

```{r figure2b, fig.cap="Series selection and analysis. Series less than 10 years are not used in the analysis. Y yellow eel series, G + GY glass and young yellow eel series. NS North Sea, EE Elsewhere Europe", fig.width=16/254}
if (file.exists(paste0(imgwd,"series_selection.png")))
  knitr::include_graphics(paste0(imgwd,"series_selection.png"))
```


```{r generation_of_plot_data, echo=FALSE, eval=TRUE, results="hide"}
###################################################
...
```{r model_for_glass_eel_and_yellow_eel_datasets, echo=FALSE, eval=TRUE, results="hide"}
...
```{r mixed_models, echo=FALSE, eval=FALSE}
...
```{r model_for_glass_eel_graph_and_predictions, echo=FALSE, eval=TRUE, results="hide"}
...
```{r segmented_regression, echo=FALSE, eval=FALSE, results="hide"}
...
```{r model_diagnostics, echo=FALSE, eval=FALSE, results="hide"}
#####deprecated
...
```{r model_for_yellow_eel, echo=FALSE, eval=TRUE, results="hide"}
...
```{r test_period, echo=FALSE, eval=FALSE, results="hide"}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%************************************************************************************
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
--->
# Annex
```{r diagramme,echo=FALSE,eval=FALSE,results="hide"}
...
```{r figure3withoutlogscale, fig.cap="Same as figure \\@ref(fig:figure3) but without log scale", fig.width=14/2.54}
knitr::include_graphics(paste0(imgwd,"figure3withoutlogscale.png"))
```


```{r figure5withlogscale, fig.cap="Same as figure \\@ref(fig:figure5) but with a log scale.", fig.width=14/2.54}
knitr::include_graphics(paste0(imgwd,"figure5_ribbon.png"))
```

```{r figure6withlogscale, fig.cap="Same graph as figure \\@ref(fig:figure6) but with a log scale.", fig.width=14/2.54}
