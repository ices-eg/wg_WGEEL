...
printstatseriesY <- printstatseries%>% 
		filter(life_stage=="Y")%>%
		arrange(order,site)%>%
		dplyr::select(site,country,areashort,duration,missing,life_stage,sampling_type,habitat_type,series_kept)%>%
		dplyr::rename("code"="site",
				"area"="areashort",
				"n+"="duration",
				"n-"="missing", 
...
xstatseriesY <- xtable(x = printstatseriesY, 
		...
		align=c("p{0cm}","p{1cm}","p{1cm}","p{0.8cm}","p{0.8cm}","p{1cm}","p{2cm}","p{2cm}","p{1cm}","p{1cm}"),
		digits=0)
print(xstatseriesY, 
