...
```{r model_diagnostics, echo=FALSE, eval=FALSE, results="hide", warning = FALSE, message = FALSE, error=FALSE, show.fig='hide'}
#####deprecated
...
```{r model_for_yellow_eel, echo=FALSE, eval=TRUE, results="hide", warning = FALSE, message = FALSE, error=FALSE, show.fig='hide'}
...
```{r test_period, echo=FALSE, eval=FALSE, results="hide", warning = FALSE, message = FALSE, error=FALSE, show.fig='hide'}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#%************************************************************************************
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
## Check on series updates for the 2019 analyses[remove this paragraph]
 ...
 `r format(vv[["nCY"]], scientific = TRUE)` time-series  updated to `r CY` `r format(vv[["nCYG"]], scientific = TRUE)` for glass eel 
 `r format(vv[["nCYGY"]], scientific = TRUE)` for glass + yellow eel 
and `r format(vv[["nCYY"]], scientific=TRUE)` for yellow eel `r format(vv[["nCYm1"]], scientific = TRUE)` 
