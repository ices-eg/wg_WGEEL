...
last_year_EE <- compute_retro_year(2023) %>% filter(year==CY-1, area =="Elsewhere Europe") %>% pull(p_std)*100
last_year_EE <- round(last_year_EE,digits= 1)
last_year_NS <- compute_retro_year(2023) %>% filter(year==CY-1, area =="North Sea") %>% pull(p_std)*100
