...
if(getUsername() == 'cedric.briand')
{
	...
	wd<-getwd()
	wddata<-gsub("C:/workspace/gitwgeel/R","F:/workspace/wgeeldata",wd)
...
# If you don't and still want to run this script, ask C�dric cedric.briand@eptb-vilaine.fr
...
wger=merge(wger,mean_site,by="site",all.x=TRUE,all.y=FALSE) # here we loose the two stations Inag and Maig and also Fr�mur
