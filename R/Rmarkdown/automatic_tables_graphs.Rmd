...
g_combined_landings_G <- g_reconstructed_landings+
    annotation_custom(g3_grob, 
        ...
        ymin=max(landings_year$eel_value)*0.9/1000, 
        ymax=max(landings_year$eel_value)*1.65/1000)
...
g_percentage_reconstructed <- ggplot(landings3)+
    ...
    theme(legend.key.height= unit(0.5, 'cm'),
          legend.key.width= unit(0.5, 'cm'))+
   theme(plot.background = element_rect(colour = "transparent",linewidth = 0))
...
g_combined_landings_YS <- g_reconstructed_landings+
    annotation_custom(g3_grob, 
        ...
        ymax=max(landings_year$eel_value)*1.65)
