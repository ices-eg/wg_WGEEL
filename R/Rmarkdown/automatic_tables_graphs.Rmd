...
fig.cap=str_c("Figure 1: Time-series of reported commercial glass eel fishery landings (tonnes), by country.",  ,"are included combining information from the Data call 2020 and the WGEEL database.", fig.height=5, fig.width=10}
toto<- "test"
##Graph
...
print(g_raw_Clandings_G<- subplot(g_raw_Clandings_G,
				...
				ymax=Inf,
				ymaxbox=70))
com_land_G_cou <- landings3$eel_cou_code
...
ggsave(paste0(imgwd,"other_landingskg_Y.png"), g_other_landingskg_Y, device = "png", width = 30, height = 20, 
		units = "cm")
ggsave(paste0(imgwd,"other_landingsY.png"), g_other_landingsY, device = "png", width = 30, height = 20, 
		units = "cm")
