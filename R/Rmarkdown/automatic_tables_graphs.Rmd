...
## Landings
```{r key numbers, results="asis", eval=TRUE, echo=FALSE}
...
knitr::asis_output(paste("Glass eel fisheries within the EU in ",CY-1," = ",g_CY1," t ", "countries where data were reported: ", paste(cou_CY1,sep="", collapse=","),"<br>"))
knitr::asis_output(paste("Glass eel fisheries within the EU in ",CY," = ",g_CY," t ", "countries where data were reported: ", paste(cou_CY,sep="", collapse=",")))
```
