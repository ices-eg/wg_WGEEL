...
simple General Linear Model (GLM) extrapolation of the log-transformed landings
...
Figure XX presents the time-series up to and including 2019 (though some 2020 data are provisional) for total glass eel landings as reported by five
