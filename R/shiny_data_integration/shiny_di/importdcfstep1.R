  ...
  tagList(useShinyjs(),
          ...
          fluidRow(                                       
            ...
            column(width=5,
                   ...
                   h3("new grouped data"),
                   htmlOutput(ns("step1_message_new_grouped_data")),
                   DT::dataTableOutput(ns("dt_new_grouped_data")),
                   h3("new individual data"),
                   htmlOutput(ns("step1_message_new_individual_data")),
                   DT::dataTableOutput(ns("dt_new_individual_data"))
            ),
            column(width=5,
