...
#A.model <- "zero"
B.model <- "identity"
Q.models <- c("diagonal and equal","diagonal and unequal") # test with different Q models(i.e. different process errors)
x0.model <- "unequal"
V0.model <- "zero"
model.constant <- list(
...
fit.model <- c(list(Z = Z.models[[i]]), A = A.model, Q=Q.model, model.constant)
fit <- MARSS(S_ts,
model = fit.model,
