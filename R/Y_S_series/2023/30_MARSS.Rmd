...
ggplot(
    Xt,
    aes(
        group = `Sub-populations`,
        y = xt,
        x = Year,
        color = `Sub-populations`
    )
) +
    geom_line() +
    geom_line(
    ...
    facet_wrap(
        ...
        ncol = length(unique(Xt$`Sub-populations`))
    ) +
    theme_bw() +
...
ggplot(
    ...
    facet_wrap(
        vars(`Sub-populations`),
        ncol = length(unique(Xt$`Sub-populations`)) / 2
    )  +
    theme_bw() +
    theme(
