...
```{r table-summary-results-long, echo=FALSE,tab.cap="Model comparisons for silver eel DFA using all the data available (since 1980)"}
results_dfa <- summary_models(modele_S_DFA_nolog)
#table_summary_models(results_dfa)

```

```{r graph-summary-results-long, echo=FALSE}
...
```{r table-summary-results-short, echo=FALSE,tab.cap="Model comparisons for silver eel DFA using the data set with the last 16 years"}
results_dfa <- summary_models(modele_S_DFA_nolog)
#table_summary_models(results_dfa)

```
```{r graph-summary-results-short, echo=FALSE}
