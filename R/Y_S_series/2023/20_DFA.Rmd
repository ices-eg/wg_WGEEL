...
```{r graph-z-long, echo=FALSE,fig.cap="Factor loadings for DFA using the dataset since 1980."}
...
```{r serie-trend-long, echo=FALSE, fig.cap="DFA fits to time series using the data set since 1980.", fig.width=16/2.54, fig.height=16/2.54}
...
```{r graph-trend-short, echo=FALSE, fig.cap="Estimated common trend in silver eel time series using the dataset since 2007"}
...
```{r graph-z-short, echo=FALSE,fig.cap="Factor loadings of the silver eel DFA using the dataset since 2007"}
...
```{r serie-trend-short, echo=FALSE, fig.cap="DFA fits to time series using the dataset since 2007", fig.width=16/2.54, fig.height=16/2.54}
