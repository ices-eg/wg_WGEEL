...
```{r mapsilverall,echo=FALSE,message=FALSE,warning=FALSE,fig.cap="Map of available silver eel time series. Updated time series correspond to time series for which at least one value was provided for the three last years.",fig.height=14/2.54}
