...
```{r figure_nseries, echo = FALSE, fig.cap = "Number of available datapoints from silver eel CPUE time-series over time, shown only for those time-series that were used in the trend analysis."}
