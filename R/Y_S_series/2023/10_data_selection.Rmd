...
d.effort = data %>%
  ...
  mutate(effort = case_when(
    ...
    ser_nameshort %in% c("BaBS",  "BidS",  "BurS",  "EamtS", "FowS", "FreS", "GiBS",  "ImsaS", "KavlS", "LevS",  "NalS",  "NorwS", "SeNS",  "ShiS",  "VaakS",  "WepeS") ~ "constant",
 ...
 notes = case_when(
   ...
   ser_nameshort %in% c("AlCS") ~ "Commercial catches, no effort known",
