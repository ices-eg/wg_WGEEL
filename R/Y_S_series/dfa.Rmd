...
There are few data series started before 2000 (Figure \@ref(fig:pointperyearYE)) so we sill restrict the analysis to the dataseries that have at least 10 observations after 2000 and stops in 2019 to avoid incomplete data in 2020. 
...
There are few data series started before 2000 so we sill restrict the analysis to the dataseries that have at least 10 observations after 2000 (Figure \@ref(fig:pointperyearSE)). 
...
```{r gamSilver, echo=FALSE,warning=FALSE, fig.cap="Trends per country in yellow eel abundance estimated by a gam"}
...
```{r vennsilver, echo=FALSE, fig.cap="Venn diagram of the yellow eel DFA"}
venn(namesseries,Z,minZ)
```
