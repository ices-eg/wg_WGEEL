...
2012 for DK, ES, a linear decrease in IE, GB, DE, and a more complex curve for
SE. The trend correspdond to log transformed and scaled values.
...
layout(matrix(1:length(cou_code), nrow = 3, byrow = TRUE))
