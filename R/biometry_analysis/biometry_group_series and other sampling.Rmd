...
```{r lengthweight_regression,echo=FALSE}
...
```{r glassyellowlengthweight_regression_table,echo=TRUE}
reg_ser=table_regression_output ("GY", "series")
autofit(flextable(reg_ser))
```

```{r glassyellowlengthweight_plots,echo=TRUE}
...
```{r yellowlengthweight_regression_table,echo=TRUE}
...
```{r yellowlengthweight_plots,echo=TRUE}
...
```{r silverengthweight_regression_table,echo=TRUE}
...
```{r silverlengthweight_plots,echo=TRUE}
plot_slope ("S", "series")
