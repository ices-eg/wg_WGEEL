...
```{r available_data, tab.cap = "Number of avaible data for each biometry metrics", include = TRUE }
...
```{r weightdecriptivegraphs, include=TRUE, fig.cap = "Weight distribution by month and by life stage. Point is the median, bar gives 5% and 95% quantile."}
...
>>>>>>> branch 'master' of git@github.com:ices-eg/wg_WGEEL.git
