...
```{r lengthdecriptivegraphs-month, include=TRUE, fig.cap = "Length distribution by month and by life stage. Point is the median, bar gives 5% and 95% quantile.", fig.height=20/2.54}
## length by month
