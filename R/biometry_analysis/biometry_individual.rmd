...
plot_map_bio_emu = function(var, stage, mydata = stats_data_coord){
  data=mydata %>%
...
<!-- `r round(Kendall(mean_biom_hty_emuY$lengthmm,mean_biom_hty_emuY$distance)$tau[1],digits=2)`,  -->
<!-- p.value=`r Kendall(mean_biom_hty_emuY$lengthmm,mean_biom_hty_emuY$distance)$sl[1]` -->
...
<!-- `r round(Kendall(mean_biom_hty_emuY$bio_weight,mean_biom_hty_emuY$distance)$tau[1],digits=2)`, p.value=`r Kendall(mean_biom_hty_emuY$bio_weight,mean_biom_hty_emuY$distance)$sl[1]` -->
. There are not enougth time sex disaggregated data to detect sex-specific length-pattern.
