...
knitr::opts_chunk$set(echo = TRUE,warning=FALSE,message=FALSE,error=FALSE,fig.width=14.9/2.54,dpi=300)
library(readxl)
library(sf)
...
plot_temporal_trend = function(var,stage,trends,sex=NULL){
  ...
  ltypes=rep(c("solid","twodash","longdash"),length.out=(nrow(trends)))
