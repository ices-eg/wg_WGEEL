...
ggplot(subset(mean_biom_hty_emuY,!is.na(bio_length)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_length,shape=ser_hty_code))+
  scale_color_viridis_c("Length (mm)")+
  scale_shape_manual(values = c(15, 17))+
  theme_bw()+xlab("")+ylab("")


ggplot(subset(mean_biom_hty_emuY,!is.na(bio_length_m)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_length_m,shape=ser_hty_code))+
  scale_color_viridis_c("Length male (mm)")+
  scale_shape_manual(values = c(15, 17))+
  theme_bw()+xlab("")+ylab("")

ggplot(subset(mean_biom_hty_emuY,!is.na(bio_length_f)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_length_f,shape=ser_hty_code))+
...
ggplot(subset(mean_biom_hty_emuY,!is.na(bio_weight)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_weight,shape=ser_hty_code))+
  scale_color_viridis_c("Weight (g)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
  theme_bw()+xlab("")+ylab("")

ggplot(subset(mean_biom_hty_emuY,!is.na(bio_weight_m)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_weight_m,shape=ser_hty_code))+
  scale_color_viridis_c("Weight (g)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
  theme_bw()+xlab("")+ylab("")

ggplot(subset(mean_biom_hty_emuY,!is.na(bio_weight_f)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_weight_f,shape=ser_hty_code))+
  scale_color_viridis_c("Weight (g)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
  theme_bw()+xlab("")+ylab("")
...
ggplot(subset(mean_biom_hty_emuY,!is.na(bio_sex_ratio)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_sex_ratio,shape=ser_hty_code))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_length)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_length,shape=ser_hty_code))+
  scale_color_viridis_c("Length (mm)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_length_m)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_length_m,shape=ser_hty_code))+
  scale_color_viridis_c("Length male (mm)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_length_f)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_length_f,shape=ser_hty_code))+
  scale_color_viridis_c("Length female (mm)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_weight)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_weight,shape=ser_hty_code))+
  scale_color_viridis_c("Weight (g)")+
  scale_shape_manual(values = c(15, 17))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_weight_m)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_weight_m,shape=ser_hty_code))+
  scale_color_viridis_c("Weight (g)")+
  scale_shape_manual(values = c(15, 17))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_weight_f)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_weight_f,shape=ser_hty_code))+
  scale_color_viridis_c("Weight (g)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
...
ggplot(subset(mean_biom_hty_emuS,!is.na(bio_sex_ratio)))+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(aes(x=ser_x,y=ser_y,col=bio_sex_ratio,shape=ser_hty_code))+
  scale_color_viridis_c("sex ratio (%)")+
  scale_shape_manual("Habitat type",values = c(15, 17))+
...
ggplot(data=allometry)+
  geom_sf(data=europe_cropped,alpha=.3)+
  geom_point(data=allometry,aes(shape=Stage,col=slopes,x=Ser_x,y=Ser_y))+
