...
if(getUsername() == 'cedric.briand')
{
	...
	setwd("C:/workspace/wgeel/wgeel_trade/")
	wd<-getwd()
...
as a text but put an antislash code before \%.
...
#price in euro per kilo
trade3. <-trade3.%>%filter(QUANTITY_IN_KG>0)
